    ...
    return <AppContext.Provider value={childContext}>
      <g className={c}
        ...
        <g ref={n => this.$wrapper = n}>
          <g className={`${c}__anchor-box`} transform='translate(0, 0) rotate(0, 0, 0), scale(1) skewX(0) skewY(0)'>
            <g className={`${c}__translate-box`} transform='translate(0, 0) rotate(0, 0, 0), scale(1) skewX(0) skewY(0)'>
              <g className={`${c}__rotate-box`} transform='translate(0, 0) rotate(0, 0, 0), scale(1) skewX(0) skewY(0)'>
                <g className={`${c}__skew-box`} transform='translate(0, 0) rotate(0, 0, 0), scale(1) skewX(0) skewY(0)'>
                  <g className={`${c}__scale-box`} transform='translate(0, 0) rotate(0, 0, 0), scale(1) skewX(0) skewY(0)'>
